                    ...
                    <div className="flex sm:flex-row flex-col justify-between items-center w-full">
                        <div className="w-full p-1 sm:p-6 sm:pt-4 flex sm:flex-row flex-col items-center gap-2 sm:min-w-[500px]">
                            <Button className="relative w-18 sm:w-44"
                                ...
                                disableRipple>
                                {userPhoto?.img ? <img src={userPhoto.img} alt="avatar" className="w-16 sm:w-36 h-16 border-4 sm:border-8 shadow-md border-neutral-200 sm:h-36 rounded-full"></img>
                                    : <div className="w-16 sm:w-36 h-16 border-4 sm:border-8  bg-neutral-100 shadow-md border-neutral-200 sm:h-36 flex items-center justify-center rounded-full">
                                        <span className="font-semibold text-neutral-600 dark:text-neutral-300 text-6xl">{user?.name!.slice(0, 1).toUpperCase()}</span>
                                    </div>
                                }
